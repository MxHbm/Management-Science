...
def Objective_Function(parameters_FirstStage:Parameters_FirstStage,    decisionVariables_FirstStage: DecisionVariables_FirstStage, 
...
def Constraints(parameters_FirstStage:Parameters_FirstStage, decisionVariables_FirstStage: DecisionVariables_FirstStage,
                parameters_SecondStage:Parameters_SecondStage, decisionVariables_SecondStage: DecisionVariables_SecondStage,
...
def Run_Model(T, F, S, FT, MP, CT, L):
    # Create a new model
    ...
    model = Objective_Function(parameters_FirstStage, decisionVariables_FirstStage, parameters_SecondStage, decisionVariables_SecondStage, binaryVariables, integerVariables, model, T, F, S, FT, MP, CT, L)

    # Add the constraints
    model = Constraints(parameters_FirstStage, decisionVariables_FirstStage, parameters_SecondStage, decisionVariables_SecondStage, binaryVariables, integerVariables, model, T, F, S, FT, MP, CT, L)
